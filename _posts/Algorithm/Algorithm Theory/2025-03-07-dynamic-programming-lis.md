...
last_modified_at: 2025-05-13 23:00:00 +0900
categories:
  - Algorithm Theory
tags:
  - dynamic programming
...
int main() {
    ...
    for (size_t i = 0; i < n; ++i) {
        ...
        pos[i] = static_cast<int>(it - lis.begin());
    }

    // 실제 LIS 복원
    int curr = static_cast<int>(n - 1);
    int lis_idx = static_cast<int>(lis.size() - 1);
